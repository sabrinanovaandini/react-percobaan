export default function EkstrakurikulerInfo() {
        ...
        <div className="detail-pk">
            ...
            <div className="dt-pk2">
                ...
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis error doloribus aut atque eum qui. Dicta minus excepturi sed, totam deleniti velit. Autem aspernatur praesentium voluptatem ipsum? Laborum, alias temporibus.
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eligendi voluptatibus error dicta, nesciunt ab quaerat eius quod nobis ipsam quibusdam vel aliquid? Itaque eius nihil obcaecati! Quibusdam aspernatur et soluta?
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex tenetur repudiandae commodi, excepturi totam voluptatibus nam est pariatur quis quas similique repellat atque labore illo id, et corporis nesciunt! Iure!
                </p>
            </div>
            ...
            <div className="card">
                <div className="card-pk">
                        <div className="card-content-row">
                            <div className="card-img-pk">
                                <img src="/images/tonti01.jpg" alt="tonti"/>
                            </div>
                ...
                <div className="card-pk">
                        <div className="card-content-row">
                            <div className="card-img-pk">
                                <img src="/images/pramuka-3.jpg" alt="pasopati"/>
                            </div>
                            <div className="card-caption-pk">
                                <h3>Pasopati</h3>
                                <p>
                ...
                <div className="card-pk">
                        <div className="card-content-row">
                            <div className="card-img-pk">
                                <img src="/images/tonti01.jpg" alt="iyos"/>
                            </div>
                            <div className="card-caption-pk">
                                <h3>IYOS</h3>
                                <p>
                ...
                <div className="card-pk">
                        <div className="card-content-row">
                            <div className="card-img-pk">
                                <img src="/images/pmr-1.jpg" alt="pmr"/>
                            </div>
                            <div className="card-caption-pk">
                                <h3>PMR</h3>
                                <p>
                ...
                <div className="card-pk">
                        <div className="card-content-row">
                            <div className="card-img-pk">
                                <img src="/images/.jpg" alt="cospala"/>
                            </div>
                            <div className="card-caption-pk">
                                <h3>Cospala</h3>
                                <p>
